/**
 * Created by shwetimahajan on 2/22/18.
 */
...
public class KNN
{
    ...
    // WritableComparable class for a paired Double and String (distance and Id)
    ...
    public static class DoubleAndLong implements WritableComparable<DoubleAndLong>
    {
        ...
        public int compareTo(DoubleAndLong o) {
            return (this.distance).compareTo(o.distance);
        }
    }

    // The mapper class accepts an object and text (row identifier and row contents) and outputs
    // two MapReduce Writable classes, NullWritable and DoubleAndLong (defined earlier)
